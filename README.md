...
## Задание: Количество квадратов (обязательное к выполнению) <a href="https://github.com/RavenRVS/QAI_HW5_T1/blob/master/src/test/java/ru/netology/qai/task1/services/SQRServiceTest.java">(моё решение) </a>
